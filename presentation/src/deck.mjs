    ...
    [
      ...
      bulletList(
        [
          ...
          "База и деплой: PostgreSQL, SQLite fallback, Aeza VPS, systemd",
  ...
  grid(
    ...
    [
      topBand(
        ...
        "Цель проекта — создать и развернуть Telegram-бота для изучения иностранной лексики с карточками, тренировками, словарем и сохранением прогресса.",
      ),
      sectionNumber("01"),
          bulletList(
            [
              ...
              "Добавить карточки, словарь, тренировки, настройки и выбор языка.",
              "Развернуть проект на VPS и обеспечить автоматический перезапуск сервиса.",
            ],
          ),
      column(
        ...
        [
          ...
          txt(
            "Работающий бот с тремя языками, карточками, словарем, тестами, прогрессом, уровнями, напоминаниями и серверным запуском.",
            24,
            { color: colors.softInk, width: wrap(500) },
          ),
        ],
        ...
        [
          ...
          bulletList(
            [
              ...
              "Ubuntu VPS и systemd для серверного запуска",
            ],
            fill,
          ),
        ],
        ...
        [
          ...
          bulletList(
            [
              ...
              "systemd автоматически поднимает бота после падения процесса или перезагрузки VPS.",
            ],
            fill,
          ),
        ],
    ...
    [
        ...
        [
          ...
          bulletList(
            [
              ...
              "keyboards/ — меню, обучение, настройки и тесты",
              "services/ — обучение, пользователи, настройки и напоминания",
            ],
            fill,
          ),
        ],
      ...
      column(
        ...
        [
          ...
          txt(
            "4. При первой регистрации пользователь выбирает язык обучения, после чего открывается главное меню.",
            24,
            { color: colors.softInk },
          ),
        ],
    ...
    [
      ...
      column(
        ...
        [
          ...
          bulletList(
            [
              "users — профиль, текущий язык, уровень и настройки",
              "word_sets — учебные темы, язык и служебные типы тестов",
        ...
        [
          ...
          bulletList(
            [
              ...
              "Разделение словаря и прогресса по текущему языку пользователя.",
              "Хранение учебных тем, карточек, словаря, слабых слов и попыток тестов.",
              "PostgreSQL используется на сервере, SQLite сохранен как локальный fallback.",
            ],
            fill,
          ),
        ],
    ...
    [
      ...
      column(
        ...
        [
          ...
          txt("Открытие бота → /start → регистрация → выбор языка → главное меню → уроки и тренировки", 28, {
            color: colors.ink,
            width: wrap(760),
          }),
        ...
        [
          ...
          bulletList(
            [
              ...
              "Выбор языка, выбор уровня и настройка напоминаний.",
    ...
    [
      ...
      column(
        ...
        [
          ...
          bulletList(
            [
              "3 языка: английский, испанский и итальянский.",
              "По 45 учебных тем и 396 карточек с примерами на каждый язык.",
        ...
        [
          ...
          bulletList(
            [
              ...
              "Настройки языка, уровня и напоминаний.",
              "PostgreSQL на VPS и локальный SQLite fallback.",
              "Обработка текстовых сообщений и устаревших кнопок.",
              "Разделение прогресса и словаря при смене языка.",
            ],
            fill,
          ),
        ],
...
addSlide(
  grid(
    ...
    [
      topBand(
        "Итоги работы",
        "В результате практики создан и развернут рабочий Telegram-бот, готовый к демонстрации на защите.",
      ),
      sectionNumber("07"),
      column(
        ...
        [
          ...
          bulletList(
            [
              ...
              "Реализованы карточки, тренировки, словарь, прогресс и выбор языка.",
              "Настроена PostgreSQL-база через SQLAlchemy.",
              "Добавлены пользовательские настройки и напоминания.",
              "Проект развернут на Aeza VPS и запущен через systemd.",
            ],
            fill,
          ),
        ],
      ...
      column(
        ...
        [
          ...
          bulletList(
            [
              "Расширение учебного контента и добавление новых языков.",
              "Добавление Alembic для версионирования миграций.",
              "Подключение внешнего словаря или переводчика.",
              "Создание админ-панели для управления темами и карточками.",
            ],
            fill,
          ),
        ],
